...
This is the main training command for GMD. It:
...
from gmd.training.callbacks.checkpoint import GMDCheckpoint
from gmd.training.callbacks.logging import RichLoggingCallback
...
def train(cfg: DictConfig) -> None:
    ...
    # Merge callbacks: GMD-specific + Hydra-configured
