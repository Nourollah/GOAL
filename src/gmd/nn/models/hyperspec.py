"""HyperSpec model — the native GMD equivariant architecture.
...
from gmd.nn.blocks.embedding import AtomicNumberEmbedding
from gmd.nn.blocks.interaction import EquivariantInteractionBlock
...
class HyperSpecModel(nn.Module):
    """Native GMD equivariant graph neural network.
